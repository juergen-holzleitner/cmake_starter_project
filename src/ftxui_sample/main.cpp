...
// configuration step. It creates a namespace called `cmake_starter_project`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_starter_project::cmake::project_name, cmake_starter_project::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_starter_project::cmake::project_version);
      return EXIT_SUCCESS;
    }
